...
>
    ...
    @if ($isDeletable)
        ...
        >
            {{
                \Filament\Support\generate_icon_html(\Filament\Support\Icons\Heroicon::XMark->value, alias: \Filament\Support\View\SupportIconAlias::BADGE_DELETE_BUTTON, attributes: (new \Illuminate\View\ComponentAttributeBag([
