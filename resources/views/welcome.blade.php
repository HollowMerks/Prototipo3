...
<body class="container">
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="flag-badge">
                ...
                <span class="badge-text">Moderado por profesionales</span>
            </div>
        </div>
    </nav>
    ...
    <section id="inicio" class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-description">Compra, vende, conecta y socializa con tu comunidad universitaria</p>
            <a href="#caracteristicas" class="cta-button">CONOCER MÁS</a>
        </div>
            ...
            <div class="benefits-list">
                <div class="benefit-item">
                    ...
                    <div class="benefit-text">
                        <strong>Comunidad Local:</strong> Conecta con estudiantes de tu ciudad y universidad
                    </div>
                </div>
                <div class="benefit-item">
                    <span class="benefit-check">✓</span>
                ...
                <div class="benefit-item">
                    <span class="benefit-check">✓</span>
                    <div class="benefit-text">
                        <strong>Entorno Seguro:</strong> Moderación activa por profesionales bolivianos
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="contacto" class="contact-section">
        <div class="container-content">
            ...
            <div class="social-container">
                <a href="https://chat.whatsapp.com/DcPCCFz3IDu9FL7k5ELfeJ" class="icon icon-whatsapp">
                ...
                <a href="https://discord.gg/Tpgg7u5b" class="icon icon-discord">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="h-8 w-8 text-white" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/Campus-Market-La-Paz" class="icon icon-github">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="h-8 w-8 text-white" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://t.me/+UxjdJ7LAzOwwYjJh" class="icon icon-telegram">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="h-8 w-8 text-white" xmlns="http://www.w3.org/2000/svg">
